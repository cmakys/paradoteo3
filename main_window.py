...
class MainWindow(BaseWindow):
    def __init__(self, parent=None):
        ...
        # Initialize cash and card amounts
    ...
    def initContent(self):
        # Main window specific content
        content_layout = QVBoxLayout()

        # Middle Layout containing all circles and labels
        middle_layout = QHBoxLayout()

        # Balance Layout (left side)
        balance_layout = QVBoxLayout()

        # Adding Wallet Icon next to Total Balance label
        balance_label = QLabel("Total Balance")
        balance_label.setFont(QFont("Arial", 24))  # Increased font size
        ...
        balance_layout.addSpacing(20)  # Add spacing after the balance section
        ...
        form_layout.setSpacing(10)  # Add spacing between form fields

        def add_form_row(label_text, placeholder_text="", widget=None):
            row_layout = QHBoxLayout()
            row_layout.setSpacing(10)  # Add spacing between label and input field
            label = QLabel(label_text)
            label.setFont(QFont("Arial", 16))
            if widget is None:
                input_field = QLineEdit()
                input_field.setPlaceholderText(placeholder_text)
                input_field.setFixedHeight(50)  # Set fixed height for larger input fields
                input_field.setFixedWidth(400)  # Set fixed width for larger input fields
                input_field.setStyleSheet("border-radius: 10px; background-color: #00FFFF; color: black;")  # Ensure text is black
            ...
            row_layout.addStretch()  # Add stretch to ensure proper alignment
    ...
    def add_to_wallet(self):
        try:
            ...
            self.save_amounts()  # Save amounts after updating
        except ValueError:
